export const config = {
    ...
    adminPassword: localStorage.getItem('adminPassword') || 'admin123', // Change this in production
    ...
    tradingMode: localStorage.getItem('tradingMode') || 'real', // 'real' for live trading, 'simulated' for demo
